...
class CampaignController extends Controller
{
    ...
    public function CampaignList(Request $request)
    {
        ...
        elseif($date_from || $date_to){
            ...
            $campaigns = Campaign::where('user_id',$users->id)->orderby('id','DESC')->paginate(10);
        }


        

        return view('reseller.management.campaign.campaign_list',compact('users','campaigns'));
    }
...
//                    $join->on('r.user_id', '=', 'c.user_id');
    ...
    public function updateCampaignStatus(Request $request) {
        ...
        DB::table('campaigns')->where('user_id', Auth::user()->id)->where('id', $request->id)->update(['status' => 3]);
        return redirect('user/campaign-details')->with('success', 'Campaign paused');
    }
    ...
    public function editCampaign(Request $request, $id) {
        ...
        return view('reseller.management.campaign.edit_campaign')->with('campaign', $campaign);
    }
    ...
    public function updateCampaign(Request $request, $id) {
        ...
        if ($strlength > 1071) {
            ...
            return redirect('/reseller/edit_campaign/' . $id);
        }
        ...
        if ($camp) {
            ...
            return redirect('/reseller/campaign/');
        } else {
