...
class DynamicSmsController extends Controller {
    ...
    public function DynamicCampaign()
    {
        ...
        return view('user.management.campaign.dynamic',compact('masks','count','templates'));
    }
    ...
    public function CampaignStore(Request $request) {
        ...
        if ($validator->fails()) {
            return redirect('/user/dynamic_sms')->withErrors($validator);
        }
        ...
        if ($request->hasFile('uploadfile')) {
            ...
            return redirect('user/dynamic_sms');
        }

        

        return view('user.management.campaign.dynamic_preview')->with(array(
                    'items' => $arrData,
...
//            print_r($arrData);exit;
    ...
    public function DynamicCampaignList(Request $request)
    {
        ...
        return view('user.management.campaign.dynamic_list',compact('users','campaigns'));
    }
...
//        Common::costAdjust();
        ...
        return view('user/campaign_management/dbcampaign')->with(['groups' => $groups, 'files' => $files, 'campaigns' => $campaigns, 'masks' => $masks, 'nonmasking' => $nonmasking]);
