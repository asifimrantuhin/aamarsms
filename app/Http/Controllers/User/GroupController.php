...
class GroupController extends Controller
{
    ...
    public function createGroup() {
        ...
        return view('user.management.group.create_group',compact('users','groups'));
    }
    ...
    { 
       $users= Auth::user();
      $groups = Group::where('user_id',$users->id)->where('type',1)->orderBy('id', 'DESC')->paginate(10);
       return view('user.management.group.index',compact('users','groups'));
    }
    ...
    public function addContactOnGroup(Request $r, $id) {
        ...
        if($count > 0) {
            ...
            return redirect('user/contact_group')->with('success', $count .' Contacts added in your group');
        } else {
            
            return redirect('user/contact_group')->with('error', 'No contact list uploaded');
        }
    }
    ...
    public function saveGroup(Request $request) {
        ...
        if ($validator->fails()) {
            return redirect('user/create_group')->withErrors($validator);
        }
...
//        echo $groupdata;exit;
        ...
        return redirect('user/create_group')->with('success', 'Group Created Successfully');
    }
