...
class TemplateController extends Controller
{
    ...
    public function index()
    {
        ...
        $users = Auth::user();
        $auth_user = $users->id;
        $templates = Template::join('users', 'users.id', '=', 'templates.user_id')
        ->select('templates.*', 'users.name as user_name')
        ->get();

        return view('admin.management.template.template',compact('templates','users'));
    }
    ...
    public function edit(Template $template,$id)
    {
        ...
        return view('admin.management.template.edit_template',compact('template','users'));
    }
