...
class GroupController extends Controller
{
    ...
    public function createGroup() {
        $users = Auth::user();
        $groups = Group::where('type','=',1)->orderBy('id', 'DESC')->paginate(5);
        return view('admin.management.group.create_group',compact('users','groups'));
    }
    ...
    { 
       ...
       $groups = Group::where('name', 'LIKE', "%{$gname}%")
       ->where('user_id', 'LIKE', "%{$user}%")
       ->where('type','=',1)->orderBy('id', 'DESC')->paginate(5);
       $users = User::orderBy('id', 'DESC')->get();


       return view('admin.management.group.index',compact('users','groups'));
    }
    ...
    public function addContactOnGroup(Request $r, $id) {
        ...
        if($count > 0) {
            ...
            return redirect('admin/contact_group')->with('success', $count .' Contacts added in your group');
        } else {
            
            return redirect('admin/contact_group')->with('error', 'No contact list uploaded');
        }
    }
    ...
    public function saveGroup(Request $request) {
        ...
        if ($validator->fails()) {
            return redirect('admin/create_group')->withErrors($validator);
        }
...
//        echo $groupdata;exit;
        ...
        return redirect('admin/create_group')->with('success', 'Group Created Successfully');
    }
