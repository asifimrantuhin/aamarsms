...
class CustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manager.management.customer.customer_list',compact('customers','area'));
    }
    ...
    public function create()
    {
        ...
        $area = Config::get('area.show');
        return view('manager.management.customer.form',compact('area'));
    }
    ...
    public function edit($id)
    {
        ...
        $area = Config::get('area.show');
        return view('manager.management.customer.edit_customer',compact('area','data','requirement'));
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect('manager/editcustomer/');
        }
    ...
    public function Conveyance(Request $request) {
        ...
        return view('manager.management.customer.convayance',compact('customers'));
    }
    ...
    public function AssignedCustomer(Request $request)
    {
        ...
        return view('manager.management.sys_user.UserList', compact('customers'));
    }
    ...
    public function RechargeHistory(Request $request)
    {
        ...
        return view('manager.management.sys_user.recharge_history',compact('recharge_history'));
    }
    ...
    public function requestlist(Request $request)
    {
        ...
        return view('manager.management.recharge_request.request_list', compact('userlists','recharge_requests'));
    }
    ...
    public function rechargeRequest(Request $request)
    {
        ...
        if ($data->save()) {
            ...
            return redirect('manager/customer_credit');
        }
    }
    ...
    public function EditPayment($id) {
        ...
        return view('manager.management.recharge_request.edit_payment',compact('data','username'));
    }
    ...
    public function CustomerCampaign(Request $request){
        ...
        return view('manager.management.customer.campaign_list',compact('campaigns'));
    }
