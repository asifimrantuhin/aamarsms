...
class AdminController extends Controller
{
    ...
    public function UserSMSReportExport(Request $request) {
        ...
        return Excel::download(new GlobalExport("admin/management/report/user_sms_export", $sms_report), 'user_sms_report.xlsx');
    ...
    public function ResellerSMSReportExport(Request $request) {
        $user = $request->input('user');
        $from_date = $request->input('from_date');
        $to_date = $request->input('to_date');
        if (empty($from_date)) {
        ...
        return Excel::download(new GlobalExport("admin/management/report/reseller_sms_export", $sms_report), 'reseller_sms_report.xlsx');
    ...
    public function SMSTransactionsExport(Request $request) {
        $from_date = $request->input('from_date');
        $to_date = $request->input('to_date');
        ...
        if ($from_date || $to_date) {
         ...
         return Excel::download(new GlobalExport("admin/management/report/sms_transaction_report_export", $sms_report), 'sms_transaction_report.xlsx');
    }
