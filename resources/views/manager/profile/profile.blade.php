...
<div class="br-mainpanel">
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Manager Profile</span>
        </nav>
    </div>
            ...
            <div class="col-md-6">
                <div class="br-section-wrapper">
                    <div class="form-layout">
                        <form class="form-horizontal" method="POST" action="{{ url('manager/updateprofile') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        <div class="row">
