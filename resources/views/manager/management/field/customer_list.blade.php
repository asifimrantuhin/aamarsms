                    ...
                    <form method="POST">
                        ...
                        <div class="align-items-center bg-gray-100 ht-md-180 bd pd-x-20">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <button type="submit" class="btn btn-info tx-uppercase tx-11 tx-spacing-2">Search</button>
                                    <a href="{{url('/manager/download_field/xlsx')}}" class="btn btn-warning tx-uppercase tx-11 tx-spacing-2">Download Data</a>
                                </div>
                            </div>
                        </div>
                        <!--Main Div  -->
