...
<div class="br-mainpanel">
    ...
    <div class="br-pagebody">
        <div class="row">
            <div class="col-lg-6">
                <div class="br-section-wrapper">
                    <div class="form-layout">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('/admin/savegroup') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
            ...
            <div class="col-lg-6">
                <div class="br-section-wrapper">
                	<a href={{url('admin/contact_group')}} <h6 class="tx-uppercase tx-bold tx-14 mg-b-10">Existing Groups</h6></a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                    	<a href="#" data-toggle="modal" data-target="#editgroup" data-id="{{ $group->id }}" class="btn btn-outline-primary btn-icon mg-r-5">
                                    		<div><i class="fa fa-pencil"></i></div>
                                    	</a>
										<a href="#" data-toggle="modal" data-target="#deletegroup" data-id="{{ $group->id }}" class="btn btn-outline-danger btn-icon mg-r-5">
