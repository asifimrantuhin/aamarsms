                ...
                <div class="col-sm-12">
                    <div class="br-section-wrapper">
                        <div class="form-layout form-layout-4">
                            <form id="campaign-form" method="POST" action="{{ url('admin/create_campaign') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div id="filediv" style="display: none" class="tabcontent">
                                            <a href="{{url('/admin/samplefile')}}" class="pull-right"><i class="fa fa-file-excel-o"></i> Sample File</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width : 120px">
                                            ...
                                            ?>
                                            @if ($date1 > $date2)
                                            <a href="{{url('admin/edit_campaign/'.$campaign->id)}}" title='Edit Campaign' class="btn btn-outline-primary btn-icon mg-r-5">
                                                <div><i class="fa fa-pencil"></i></div>
                                            </a>
                                            <a href="{{url('admin/delete_campaign/'.$campaign->id)}}" title='Delete Campaign' class="btn btn-outline-danger btn-icon mg-r-5 ">
                ...
                <div class="modal-content bd-0 tx-14">
                    ...
                    <div class="br-section-wrapper">
                        <div class="form-layout">
                            <form id="createnewgroup" action="{{ url('/admin/contact/savecontactgroup') }}"
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('#preview').click(function() {
                    ...
                    var url = "<?php echo url('admin/preview_campaign'); ?>";
        ...
        callback: function(result) {
            ...
            formdata.append('file_msisdn_contact', filedata);
                        ...
                        $.ajax({
                                                ...
                                                success: function(data) {
                                                    console.log(data);
                                                    window.location.href ="<?php echo url('admin/campaign'); ?>";
                                                },
                                                error: function(data) {
                                                    console.log(data);
                                                    window.location.href ="<?php echo url('admin/campaign'); ?>";
