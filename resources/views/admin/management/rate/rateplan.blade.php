      ...
      <div class="modal-content tx-size-sm">
        ...
        <div class="modal-body pd-20">
            ...
            <div class="form-layout form-layout-1">
                <form class="form-horizontal" method="POST" action="{{ url('admin/rateplan/store') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                                ...
                                <table class="table table-bordered mg-b-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" name="nonmasking_price[]" value="0.3000"></td>
                                            <td><input type="text" class="form-control" name="masking_price[]" value="0.5000"></td>
                                        </tr>
                                        <tr>
