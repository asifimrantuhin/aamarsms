                ...
                <div class="br-section-wrapper">
                    <div class="form-layout">
                        ...
                        <form class="form-horizontal" method="POST"
                            action="{{ url('/admin/updateCustomer/'.$data->id) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row mg-t-20">
                                        <label class="col-sm-4 form-control-label">Company Name: <span
                                                class="tx-danger">*</span></label>
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <input type="text" name="cname" value="{{$data->cname}}"
                                                class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mg-t-20">
                                        <label class="col-sm-4 form-control-label">Company Address: <span
                                                class="tx-danger">*</span></label>
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                    ...
                                    <div class="row mg-t-20">
                                        <label class="col-sm-4 form-control-label">Contact Person Name: <span
                                                class="tx-danger">*</span></label>
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <input type="text" name="cperson" value="{{$data->cperson}}"
                                                class="form-control" />
                                        </div>
                                    </div>

                                    <div class="row mg-t-20">
                                        <label class="col-sm-4 form-control-label">Designation: <span
                                                class="tx-danger">*</span></label>
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                    ...
                                    <div class="row mg-t-20">
                                        ...
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            ...
                                            <label>
                                                <input type="checkbox" name="requirement[]" value="masking"
                                                    {{in_array("masking",$requirement)?"checked":""}}> Masking
                                                &nbsp;&nbsp;&nbsp;
                                                <input type="checkbox" name="requirement[]" value="non-masking"
                                                    {{in_array("non-masking",$requirement)?"checked":""}}> Non-Masking
                                                    &nbsp;&nbsp;&nbsp;
                                                <input type="checkbox" name="requirement[]" value="Location-based"
                                                    {{in_array("Location-based",$requirement)?"checked":""}}> Location-based
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mg-t-20">
                                        <label class="col-sm-4 form-control-label">Customer Priority: <span
                                                class="tx-danger">*</span></label>
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <select class="form-control" name="priority" required>
                                                <option value="">Select Priority</option>
                                                <option value="high"
                                                    <?php if($data->priority =="high") echo 'selected="selected"'; ?>>
                                                    High</option>
                                                <option value="medium"
                                                    <?php if($data->priority =="medium") echo 'selected="selected"'; ?>>
                                                    Medium</option>
                                                <option value="low"
                                                    <?php if($data->priority =="low") echo 'selected="selected"'; ?>>Low
                                                </option>
                                                <option value="Succeed"
                                                    <?php if($data->priority =="Succeed") echo 'selected="selected"'; ?>>Succeed
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mg-t-20">
                                        <label class="col-sm-4 form-control-label">Customer FeedBack(Recent): <span
                                                class="tx-danger">*</span></label>
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                    ...
                                    <div class="row mg-t-20">
                                        <label class="col-sm-4 form-control-label">Visiting Date: <span
                                                class="tx-danger">*</span></label>
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                        ...
                                        <div class="row mg-t-20">
                                            ...
                                            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                <select class="form-control" name="transaport">
                                                    ...
                                                    <option value="bus"
                                                        <?php if($data->transaport =="bus") echo 'selected="selected"'; ?>>
                                                        Bus</option>
                                                    <option value="rickshaw"
                                                        <?php if($data->transaport =="rickshaw") echo 'selected="selected"'; ?>>
                                                        Rickshaw</option>
                                                    <option value="private"
                                                        <?php if($data->transaport =="private") echo 'selected="selected"'; ?>>
                                                        Private</option>
                                                    <option value="walk"
                                                        <?php if($data->transaport =="walk") echo 'selected="selected"'; ?>>
                                                        Walk</option>
                                                </select>
                                            </div>
                                        </div>
