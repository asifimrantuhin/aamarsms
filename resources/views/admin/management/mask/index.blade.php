...
<div class="br-mainpanel">
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Manage Mask</span>
        </nav>
    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-end bg-gray-100 ht-md-80 bd pd-x-20 mg-t-10">
                        <form method="GET" autocomplete="off">
                            ...
                            <div class="d-md-flex pd-y-20 pd-md-y-0">
                                ...
                                <a href="" class="btn btn-info  pd-y-12 pd-x-25" data-toggle="modal" data-target="#modaldemo1">New Mask <i class="fa fa-plus"></i></a>
                                </div>
                                <div class="input-group  mg-b-10 mg-r-10">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown show">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                              <a  href="#">
                                                @if($mask->status)
                                                <a href="{{url('/admin/mask_status/'.$mask->id.'/0')}}" class="dropdown-item"><i class="ion-pause"> Inactive</i></a>
                                                @else
                                                 <a href="{{url('/admin/mask_status/'.$mask->id.'/1')}}"  class="dropdown-item"><i class="ion-checkmark"> Active</i></a>
                                                 @endif
                                                 @if($mask->status == 0)
...
<div id="modaldemo1" class="modal fade">
    <div class="modal-dialog modal-dialog-vertical-center" role="document">
      <div class="modal-content bd-0 tx-14">
        <form class="form-horizontal" method="POST" action="{{ url('admin/mask/store') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
        <div class="modal-header pd-y-20 pd-x-25">
          <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Insert Mask</h6>
        ...
        <div class="modal-body pd-25">
            ...
            <div class="row">
                <label class="col-sm-5 form-control-label">Mask Name: <span class="tx-danger">*</span></label>
                <div class="col-sm-7 mg-t-10 mg-sm-t-0">
                    <input type="text" name="name" class="form-control" placeholder="Enter Mask Name" required="" />
                </div>
            </div>
...
$('#deletemask').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type : 'get',
        url: '{{ url('/admin/viewmask/') }}/'+ id,
        success : function(mask){
            $('#mask_name').val(mask[0].name);
            $("#deletemsk").attr('href', '/admin/delete_mask/'+mask[0].id);
        }
    });
 });
});
