...
<div class="br-header">
    ...
    @if($punch>0)
    <a class="btn btn-warning" href={{url('manager/attendence')}}>Check Out <i class="fa fa-fingerprint"></i></a>
    @else
    <a class="btn btn-info text-white" href={{url('manager/attendence')}}>Check In <i class="fa fa-fingerprint"></i></a>
     @endif
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-header wd-200">
                    <ul class="list-unstyled user-profile-nav">
                        <li><a href="{{url('manager/profile')}}"><i class="icon ion-ios-person"></i> Profile</a></li>
