<div class="br-header">
    ...
    <div class="br-header-right">
        ...
        <nav class="nav">
            ...
            {{-- Data Source --}}
            @php
            $notification = App\Models\Notification::where(['status'=>1,'reseller'=>1])->orderby('id','DESC')->paginate(5);
            @endphp
            {{-- Data Source --}}
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-header wd-200">
                    <ul class="list-unstyled user-profile-nav">
                        <li><a href="{{url('reseller/profile')}}"><i class="icon ion-ios-person"></i>My Profile</a></li>
                        <li><a href="{{url('reseller/company')}}"><i class="icon ion-ios-gear"></i>Company Profile</a></li> 
