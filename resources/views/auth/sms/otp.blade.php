...
<div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base">
        ...
        @endif
        <p><strong>{{App\Models\User::whereId($last_insert_id)->pluck('name')->first();}} </strong> Please check your mobile message</p>
                    <form class="form-horizontal" method="POST" action="{{url('/verifySMS')}}">
                        {{ csrf_field() }}
