            ...
            <div class="col-lg-6">
                <div class="br-section-wrapper">
                    <div class="form-layout">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('sales/update_payment/'.$data[0]->id) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="row mg-t-20">
                                ...
                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                    <select class="form-control" id="selector" onchange="PaymentCheck(this);" name="method">
                                        <option value="1" <?php if ($data[0]->sales_status == 1) echo 'selected="selected"'; ?>>Received</option>
                                        <option value="2" <?php if ($data[0]->sales_status == 2) echo 'selected="selected"'; ?>>Pending</option>
                                    </select>
                                </div>
                            </div>
