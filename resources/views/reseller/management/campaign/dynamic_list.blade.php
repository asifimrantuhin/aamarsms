                    ...
                    @foreach($campaigns as $campaign)
                        ...
                        <td>
                            <div class="dropdown show">
                                ...
                                <a class="dropdown-item" href="{{ url('/reseller/download/xls/'.$campaign->id) }}">
                                        <div><i class="fa fa-download"> </i>XLS Download</div></a>
                                <a class="dropdown-item" href="{{ url('/reseller/download/csv/'.$campaign->id) }}">
                                        <div><i class="fa fa-download"></i> CSV Download</div></a>
                                        @if($fail != 0)
                                <a class="dropdown-item" href="{{ url('/reseller/resend_campaign/'.$campaign->id) }}">
                        ...
                        <td>
                            <div class="dropdown show ">
                                ...
                                <a class="dropdown-item" href="{{ url('/reseller/successdownload/xls/'.$campaign->id) }}">
                                        <div><i class="fa fa-download"></i> XLS Download</div></a>
                                <a class="dropdown-item" href="{{ url('/reseller/successdownload/csv/'.$campaign->id) }}">
                                        <div><i class="fa fa-download"></i> CSV Download</div></a>
                                </div>
                              </div> 
                        </td>
