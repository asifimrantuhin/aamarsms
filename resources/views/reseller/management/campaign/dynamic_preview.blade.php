        ...
        <div class="br-section-wrapper">
            <div class="row">
                <div class="col-12">
                    ...
                    <form id='confirm_campaign' method="POST" action="{{ url('/reseller/store_dynamic_sms')}}" >
                        {{csrf_field()}}
                        ...
                        <div class="form-layout-footer mg-t-30">
                            <button type="submit" class="btn btn-info"
                                    ...
                                    @endif
                                    >Confirm</button>
                            <a href="{{ url('reseller/dynamic_sms') }}" class="btn btn-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
...
if(rem >= 0 ){
        ...
        $.ajax({
            ...
            success: function (data)
            {
                //console.log(data);
                 if(data = 'success'){
                     window.location.href = "<?php echo url('reseller/dynamic_sms?message=') ?>"+ data;
                 }else{
                     window.location.href = "<?php echo url('reseller/dynamic_sms?') ?>"+ data;
                 }
            },
            error: function (data)
            {
