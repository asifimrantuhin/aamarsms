                    ...
                    <div class="bd bd-gray-300 rounded table-responsive">
                        <table class="table mg-b-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><div class="dropdown show ">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink"></a>
                                              ...
                                              <a href="#" data-toggle="modal" data-target="#importContact" data-id="{{ $group->id }}" class="dropdown-item" href="#"><div><i class="fa fa-cloud-upload"> Upload Contact</i></div></a>
                                              ...
                                              <a href="{{url('/reseller/download_contacts/xlsx/'.$group->id)}}" class="dropdown-item"><div><i class="fa fa-download"> XLS File</i></div></a>
                                              <a href="{{url('/reseller/download_contacts/csv/'.$group->id)}}" class="dropdown-item"><div><i class="fa fa-download">  CSV File</i></div></a>
                                ...
                                @else
                                <tr>
                                    <td colspan="3">No Groups Data Found !!!</td>
                                </tr>
                                @endif
