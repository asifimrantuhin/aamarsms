                ...
                <div class="col-sm-12">
                    <div class="br-section-wrapper">
                        <div class="form-layout form-layout-4">
                            <form id="campaign-form" method="POST" action="{{ url('user/dynamic_campaign') }}"  enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-8">
                                        <label class="form-control-label"><strong>Enter SMS</strong><span
                                                class="tx-danger">*</span> &nbsp;
                                                <a href="{{url('/user/dynamicsms')}}" class="pull-right">Sample SMS <i class="fa fa-download"></i></a>
                                            </label>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="row">
                                            ...
                                            class="tx-danger">*</span>
                                            <a href="{{url('/user/dynamicfile')}}" class="pull-right">Sample File</a>
                                        </label></div>                          
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-4">
