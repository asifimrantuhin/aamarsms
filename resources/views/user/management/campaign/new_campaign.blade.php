                ...
                <div class="form-layout form-layout-4">
                    <form id="campaign-form" method="POST" action="{{ url('user/create_campaign') }}"  enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <label class="form-control-label"><strong>Mask/SenderID (?)</strong></label>
                                <select id="SenderIdShow" style="display: block" class="form-control"
                                    name="senderid">
                                    <option value="">Default</option>
                                    @foreach ($nonmasks as $nonmask)
                                    <option value="{{ $nonmask->name }}">{{ $nonmask->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <label class="form-control-label"><strong>Enter SMS</strong><span class="tx-danger">*</span> &nbsp; &nbsp;
                                <a href="" class="tx-11 tx-uppercase" data-toggle="modal" data-target="#modaldemo1">use template</a></label>
                                </br>
                            ...
                            <div class="col-sm-4">
                                <div class="row">
                                    <div class="col-3">
                                        <label class="form-control-label">
                                            <strong>Numbers</strong><span class="tx-danger">*</span>
                                ...
                                <div id="commadiv" style="display: block" class="tabcontent">
                                    <textarea rows="6" type="text" id="raw_msisdn" name="raw_msisdn" row="3" class="form-control"
                                        placeholder="Enter mobile no e.g 880171XXXXXXX, 880191XXXXXXX"></textarea>
                                </div>
                                <div id="filediv" style="display: none" class="tabcontent">
                                    <a href="{{url('/user/samplefile')}}" class="pull-right"><i class="fa fa-file-excel-o"></i> Sample File</a>
