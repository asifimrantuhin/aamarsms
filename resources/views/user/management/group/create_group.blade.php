...
<div class="br-mainpanel">
    ...
    <div class="br-pagebody">
        <div class="row">
            <div class="col-lg-6">
                <div class="br-section-wrapper">
                    <div class="form-layout">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('/user/savegroup') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
            ...
            <div class="col-lg-6">
                <div class="br-section-wrapper">
                	<a href={{url('user/contact_group')}} <h6 class="tx-uppercase tx-bold tx-14 mg-b-10">Existing Groups</h6></a>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown show">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <a href="#" data-toggle="modal" data-target="#editgroup" data-id="{{ $group->id }}" class="dropdown-item">
                                                    <div><i class="fa fa-pencil"> Modify</i></div>
                                                </a>
                                                <a href="#" data-toggle="modal" data-target="#deletegroup" data-id="{{ $group->id }}" class="dropdown-item">
                                                    <div><i class="fa fa-trash"> Delete</i></div>
                                                </a>
                                            </div>
                                          </div>
                                    </td>
                    ...
                    <br/>
                    <p>{{ $groups->appends(array_filter(Request::all()))->links("pagination::bootstrap-4") }}</p>
                </div>
            </div>
        </div>
    </div>      
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#editgroup').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type : 'get',
                url: '{{ url('/user/viewgroup/') }}/'+ groupid,
